...
Future<String?> getIPAddress(String period) async {
  ...
  var url =
      'https://api.huobi.pro/market/history/kline?period=$period&size=449&symbol=btcusdt';
      // 'https://api.huobi.pro/market/history/kline?period=1day&size=449&symbol=btcusdt';
  String? result;
